...
export default async function AdminSignupPage({ searchParams }: AdminSignupPageProps) {
  ...
  return (
    <AuthSplitLayout
      contentAlign="center"
      panelTitle="Entras y sales vendiendo"
      panelDescription="El objetivo es que tu negocio tenga su página pública, panel y agenda listos en minutos, sin depender de una configuración manual."
    >
      <div className="mt-12">
