...
function NavBadge({ count }: { count: number }) {
  ...
  return (
    <span className="animate-fade-in ml-auto inline-flex min-w-5 items-center justify-center rounded-full bg-red-500 px-1.5 py-0.5 font-mono text-[10px] font-bold text-white">
      {count > 99 ? "99+" : count}
    </span>
  );
}
