    ...
    <section className="relative mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 px-4 pb-16 pt-32 sm:px-6 sm:pb-20 sm:pt-36 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16 lg:px-8 lg:pb-24 lg:pt-40">
      ...
      <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
        ...
        <AnimatedSection delay={100}>
          <h1 className="max-w-[620px] text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl leading-[1.05] font-display">
            ...
            <span className="block mt-2 text-muted-foreground font-display italic font-normal text-2xl sm:text-3xl">
        ...
        <AnimatedSection delay={200}>
          <p className="mt-6 sm:mt-8 max-w-[520px] text-lg leading-relaxed text-muted-foreground sm:text-xl lg:max-w-[480px]">
        ...
        <AnimatedSection delay={300}>
          <div className="mt-10 sm:mt-12 flex flex-col flex-wrap items-center justify-center gap-4 w-full sm:w-auto sm:flex-row lg:justify-start">
            <Link
              href="/admin/signup"
              className={cn(
                "group inline-flex items-center justify-center gap-2 w-full sm:w-auto",
                "h-14 whitespace-nowrap rounded-full px-8 text-base",
            ...
            >
              ...
              <svg className="w-4 h-4 shrink-0 transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a
              ...
              className={cn(
                ...
                "h-14 whitespace-nowrap rounded-full px-6 text-base",
