...
export function WhatsAppWidget({ 
  ...
  return (
    <div className={cn("fixed bottom-4 right-4 z-50 flex flex-col items-end gap-2", className)}>
      {/* Ventana de chat */}
      {isOpen && (
        <div className="mb-2 w-72 rounded-2xl bg-card p-4 shadow-2xl animate-in slide-in-from-bottom-2 fade-in duration-200 border border-border/60">
          <div className="flex items-center gap-3 border-b border-border/60 pb-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Respondemos en minutos</p>
            </div>
          </div>
          <div className="py-3">
      ...
      <button
        ...
        className={cn(
          ...
          isOpen ? "bg-foreground hover:bg-foreground/90" : "bg-green-500 hover:bg-green-600"
        )}
